...
describe('IntegriteeKusama', () => {
  ...
  beforeEach(() => {
    chain = getNode<unknown, unknown, 'IntegriteeKusama'>('IntegriteeKusama')
    vi.clearAllMocks()
  })

  it('should initialize with correct values', () => {
    expect(chain.node).toBe('IntegriteeKusama')
  ...
  it('should handle local non-native asset transfers', () => {
    ...
    expect(assertHasId).toHaveBeenCalledWith(options.asset)
