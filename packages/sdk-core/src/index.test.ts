...
describe('Module Exports', () => {
  it('should export CHAIN_NAMES_DOT_KSM and other constants', () => {
    expect(sdk.CHAIN_NAMES_DOT_KSM).toBeDefined()
    expect(sdk.CHAIN_NAMES).toBeDefined()
    expect(sdk.CHAINS_WITH_RELAY_CHAINS).toBeDefined()
    expect(sdk.CHAINS_WITH_RELAY_CHAINS_DOT_KSM).toBeDefined()
