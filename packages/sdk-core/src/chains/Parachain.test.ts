...
describe('Parachain', () => {
  ...
  it('should perform eth asset transfer with deposit asset only instruction', async () => {
    ...
    await chain.exposeTransferToEthereum(options, true)
  ...
  describe('transferEthAssetViaAH', () => {
    ...
    it('should throw an error if the asset has no location', async () => {
      await expect(
        chain.exposeTransferEthAssetViaAH({
          ...options,
    ...
    it('should throw an error if dry-run fails', async () => {
      ...
      await expect(chain.exposeTransferEthAssetViaAH(options)).rejects.toThrowError()
    })
    ...
    it('should perform eth asset transfer via AH', async () => {
      ...
      await chain.exposeTransferEthAssetViaAH(options)
