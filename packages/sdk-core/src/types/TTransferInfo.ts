...
import type { TChainDotKsmWithRelayChains, TChainWithRelayChains } from '@paraspell/sdk-common'
...
export type TTransferInfo = {
  chain: { origin: TChainWithRelayChains; destination: TChainWithRelayChains; ecosystem: string }
  origin: {
    selectedCurrency: {
      sufficient: boolean
      balance: bigint
