...
describe('AssetsPallet.setBalance', () => {
  ...
  it('uses BigInt id and raw address for Moonbeam/Astar/Shiden and returns correct txs', () => {
  ...
  it('uses Number id and { Id: address } on non-EVM chains and returns correct txs', () => {
    const pallet = new AssetsPallet()
