...
describe('buildHopInfo', () => {
  ...
  beforeEach(() => {
    ...
    baseOptions = {
      api: mockApi,
      chain: 'AssetHubPolkadot' as TChainDotKsmWithRelayChains,
      feeData: {
        fee: DEFAULT_HOP_FEE,
        currency: 'DOT'
      },
      originChain: 'Polkadot' as TChainDotKsmWithRelayChains,
  ...
  it('should use ahAddress for EVM origin if provided', async () => {
    ...
    const options = { ...baseOptions, originChain: 'Moonbeam' as TChainDotKsmWithRelayChains }
  ...
  it('should use senderAddress for EVM origin if ahAddress is NOT provided', async () => {
    ...
    const options = {
      ...baseOptions,
      originChain: 'Moonbeam' as TChainDotKsmWithRelayChains,
      ahAddress: undefined
    }
    await buildHopInfo(options)
  ...
  it('should correctly build info for a BridgeHub hop chain', async () => {
    const chain = 'BridgeHubPolkadot' as TChainDotKsmWithRelayChains
