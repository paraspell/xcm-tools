...
describe('BalancesPallet.setBalance', () => {
  ...
  it('uses address string for Hydration chains', () => {
    ...
    const res = pallet.setBalance(address, asset, chain)
  ...
  it('uses address string for Basilisk', () => {
    const pallet = new BalancesPallet()
    const address = 'Alice'
  ...
  it('uses address string when chain is EVM', () => {
    const pallet = new BalancesPallet()
  ...
  it('uses { Id: address } for other non-EVM chains', () => {
    const pallet = new BalancesPallet()
