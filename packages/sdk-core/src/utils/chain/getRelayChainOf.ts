import type { TChainDotKsmWithRelayChains, TRelayChain } from '@paraspell/sdk-common'
 ...
 */
export const getRelayChainOf = (chain: TChainDotKsmWithRelayChains): TRelayChain => {
