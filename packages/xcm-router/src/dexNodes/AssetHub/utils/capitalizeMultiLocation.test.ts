...
import { capitalizeKeys, capitalizeMultiLocation } from './capitalizeMultiLocation';
...
describe('capitalizeMultiLocation', () => {
  ...
  it('should return the original object instance, modified', () => {
    ...
    const result = capitalizeMultiLocation(obj);
