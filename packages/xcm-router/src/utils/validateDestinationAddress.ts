import { InvalidAddressError, isChainEvm, type TChainWithRelayChains } from '@paraspell/sdk-pjs';
import { ethers } from 'ethers-v6';

export const validateDestinationAddress = (address: string, destination: TChainWithRelayChains) => {
