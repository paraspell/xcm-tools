...
type TSnowbridgeNetwork = Parameters<typeof bridgeInfoFor>[0]
...
const fetchEthereumAssetsForNetwork = async (
  network: TSnowbridgeNetwork
): Promise<TAssetInfo[]> => {
