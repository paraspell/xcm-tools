...
import { fetchJamtonAssets, fetchJamtonNativeAssets } from './jamton'
...
export const getOtherAssetsFetcher = (chain: TSubstrateChain): TAssetsFetcher | undefined => {
  ...
  if (chain === 'Jamton') return fetchJamtonAssets
...
export const getNativeAssetsFetcher = (chain: TSubstrateChain): TAssetsFetcher | undefined => {
