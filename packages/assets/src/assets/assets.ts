...
import type { TChainWithRelayChains, TRelayChainSymbol } from '@paraspell/sdk-common'
 ...
 */
export const getAssetsObject = (chain: TChainWithRelayChains): TChainAssetsInfo => assetsMap[chain]

export const isChainEvm = (chain: TChainWithRelayChains): boolean => {
 ...
 */
export const getAssetId = (chain: TChainWithRelayChains, symbol: string): string | null => {
 ...
 */
export const getRelayChainSymbol = (chain: TChainWithRelayChains): TRelayChainSymbol =>
  getAssetsObject(chain).relayChainAssetSymbol
 ...
 */
export const getNativeAssets = (chain: TChainWithRelayChains): TNativeAssetInfo[] =>
 ...
 */
export const getOtherAssets = (chain: TChainWithRelayChains): TForeignAssetInfo[] => {
 ...
 */
export const getAssets = (chain: TChainWithRelayChains): TAssetInfo[] => {
 ...
 */
export const getAllAssetsSymbols = (chain: TChainWithRelayChains): string[] => {
  const { nativeAssets, otherAssets } = getAssetsObject(chain)
 ...
 */
export const getNativeAssetSymbol = (chain: TChainWithRelayChains): string => {
 ...
 */
export const hasSupportForAsset = (chain: TChainWithRelayChains, symbol: string): boolean => {
 ...
 */
export const getAssetDecimals = (chain: TChainWithRelayChains, symbol: string): number | null => {
...
export const hasDryRunSupport = (chain: TChainWithRelayChains): boolean => {
  return getAssetsObject(chain).supportsDryRunApi
}

export const hasXcmPaymentApiSupport = (chain: TChainWithRelayChains): boolean => {
