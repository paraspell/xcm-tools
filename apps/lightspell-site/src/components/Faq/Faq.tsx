    ...
    <Accordion variant="separated">
      <Accordion.Item className={classes.item} value="what-is-xcm-api">
        ...
        <Accordion.Panel>
          ...
          and Westend ecosystems. It enables developers to interact with various
          blockchain protocols directly over HTTP, making it easier to build and
      ...
      <Accordion.Item className={classes.item} value="start-using-xcm-api">
        ...
        <Accordion.Panel>
          To use XCM API, simply make HTTP requests from your application to our
          API endpoints. There&apos;s no need to install any dependencies. Check
          our documentation for detailed API endpoints, request formats, and
      ...
      <Accordion.Item className={classes.item} value="api-costs">
        ...
        <Accordion.Panel>
          ...
          key, users are limited to 20 requests per minute. By generating an API
          key, this limit increases to 100 requests per minute, facilitating the
          development and scaling of applications. To obtain an API key, you can{" "}
          <Anchor
          ...
          . Additionally, for applications that require higher request volumes,
          you can{" "}
          <Anchor
          ...
          . For those who choose to deploy the XCM API instance themselves, the
          predefined rate limits do not apply, offering more flexibility for
          application development. Regardless of deployment, transaction fees
          related to blockchain operations may still apply and vary by network.
          This makes the XCM API a cost-effective option for both development
          and production environments, especially when managing resources and
          application scaling strategically.
        </Accordion.Panel>
      </Accordion.Item>
