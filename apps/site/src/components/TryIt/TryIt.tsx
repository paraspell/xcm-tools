    ...
    <div className={classes.wrapper} id="try-it">
      <div className={classes.body}>
        ...
        <Text c="dimmed" maw={550}>
          Get hands-on with our XCM tools instantly in our interactive
          playground. No setup needed — just experiment, see real-time results,
          and explore the full potential of our XCM solutions for your projects.
          Ready to discover how effortlessly you can integrate XCM
          functionality?
        </Text>
