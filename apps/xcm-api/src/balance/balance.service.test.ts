...
describe('BalanceService', () => {
  ...
  describe('getBalanceNative', () => {
    it('should throw BadRequestException for an invalid chain', () => {
      const invalidChain = 'invalid-chain';
      const params: BalanceNativeDto = { address: '0x1234567890' };

      expect(() => service.getBalanceNative(invalidChain, params)).toThrow(
        BadRequestException,
      );
    });
  ...
  describe('getExistentialDeposit', () => {
    it('should throw BadRequestException for an invalid chain', () => {
      ...
      expect(() => service.getExistentialDeposit(invalidChain, params)).toThrow(
        BadRequestException,
      );
    });
