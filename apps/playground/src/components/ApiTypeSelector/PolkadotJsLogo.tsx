export const PolkadotJsLogo = () => (
  <svg
    xmlSpace="preserve"
    viewBox="46.64 34.040000000000006 77 101.08"
    y="0px"
    x="0px"
    id="Layer_1"
    ...
    height={14}
  >
    <style type="text/css">{'.bg0{fill:transparent}'}</style>
    <g>
      <circle r={70} cy={85} cx={85} className="bg0" />
      <g>
        <path
