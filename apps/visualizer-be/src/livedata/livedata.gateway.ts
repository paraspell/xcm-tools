...
import { SubscanClient, SubscanXcmItem } from './subscan.client';
  ...
  implements OnGatewayInit, OnGatewayConnection, OnGatewayDisconnect
{
  ...
  handleConnection(client: Socket) {
    ...
    console.log('[WebSocket] Connected - total:', this.clients.size);
  ...
  private stopPolling() {
    console.log('[WebSocket] No client connected.');
    if (this.timer) {
